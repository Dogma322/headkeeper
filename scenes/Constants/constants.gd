...
@export var hd_berserk_damage_to_enemy := 4
...
@export var hd_chaos_damage_level_1 := 5
@export var hd_chaos_damage_level_2 := 6
@export var hd_chaos_damage_level_3 := 7
@export var hd_chaos_damage_to_hero := 2

@export_subgroup("Druid", "hd_druid")
@export var hd_druid_fury_level_1 := 3
@export var hd_druid_fury_level_2 := 4
@export var hd_druid_fury_level_3 := 5
...
@export var hd_false_king_health_decrement := 35
...
@export var hd_apostle_health_decrement := 25
...
@export var hd_warden_max_hp_increment_level_2 := 35
@export var hd_warden_max_hp_increment_level_3 := 45
