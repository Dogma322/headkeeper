...
@export var probability_event_weight: float = 5.0


func probability_sum() -> float:
	return probability_battle_weight + probability_battle_elite_weight + probability_shop_weight + probability_bonus_weight + probability_campfire_weight + probability_event_weight
