...
@onready var h_thorns = preload("res://scenes/BoardBonuses/HeroBonuses/bb_h_4_thorns.tscn")
...
@onready var e_10heal = preload("res://scenes/BoardBonuses/EnemyBonuses/bb_e_10_heal.tscn")
